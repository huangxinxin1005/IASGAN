...
def calculate_params(res_mat):
    ...
    for layer in layerList:
        ...
        res_dict[layer]['ART_Precision'] = res_dict[layer]['ART_TruePositiveNum'] / (
                    res_dict[layer]['ART_TruePositiveNum'] + res_dict[layer]['ART_FalsePositiveNum'])
        ...
        res_dict[layer]['ART_Recall'] = res_dict[layer]['ART_TruePositiveNum'] / (
                    res_dict[layer]['ART_TruePositiveNum'] + res_dict[layer]['ART_FalseNegativeNum'])

        AVG_ART_IOU_up += res_dict[layer]['ART_TruePositiveNum']
        AVG_ART_IOU_down += res_dict[layer]['ART_TruePositiveNum'] + res_dict[layer]['ART_FalseNegativeNum'] + \
                            res_dict[layer]['ART_FalsePositiveNum']
        res_dict[layer]['ART_IOU'] = res_dict[layer]['ART_TruePositiveNum'] / (
                res_dict[layer]['ART_TruePositiveNum'] + res_dict[layer]['ART_FalseNegativeNum'] + res_dict[layer][
            'ART_FalsePositiveNum'])
        AVG_ART_Dice_up += 2 * res_dict[layer]['ART_TruePositiveNum']
        AVG_ART_Dice_down += 2 * res_dict[layer]['ART_TruePositiveNum'] + res_dict[layer]['ART_FalseNegativeNum'] + \
                             res_dict[layer]['ART_FalsePositiveNum']
        res_dict[layer]['ART_IOU'] = 2 * res_dict[layer]['ART_TruePositiveNum'] / (
                2 * res_dict[layer]['ART_TruePositiveNum'] + res_dict[layer]['ART_FalseNegativeNum'] + res_dict[layer][
            'ART_FalsePositiveNum'])

        AVG_Dias_minH_abs_dev_up += res_dict[layer]['Dias_minH_abs_dev']
        AVG_Dias_minH_abs_dev_down += res_dict[layer]['Dias_TruePositiveNum']
        res_dict[layer]['Dias_minH_abs_dev'] = res_dict[layer]['Dias_minH_abs_dev'] / res_dict[layer][
            'Dias_TruePositiveNum']
        AVG_Dias_maxF_abs_dev_up += res_dict[layer]['Dias_maxF_abs_dev']
        AVG_Dias_maxF_abs_dev_down += res_dict[layer]['Dias_TruePositiveNum']
        res_dict[layer]['Dias_maxF_abs_dev'] = res_dict[layer]['Dias_maxF_abs_dev'] / res_dict[layer][
            'Dias_TruePositiveNum']
        ...
        res_dict[layer]['Dias_Precision'] = res_dict[layer]['Dias_TruePositiveNum'] / (
                    res_dict[layer]['Dias_TruePositiveNum'] + res_dict[layer]['Dias_FalsePositiveNum'])
        ...
        res_dict[layer]['Dias_Recall'] = res_dict[layer]['Dias_TruePositiveNum'] / (
                    res_dict[layer]['Dias_TruePositiveNum'] + res_dict[layer]['Dias_FalseNegativeNum'])
        AVG_Dias_IOU_up += res_dict[layer]['Dias_TruePositiveNum']
        AVG_Dias_IOU_down += res_dict[layer]['Dias_TruePositiveNum'] + res_dict[layer]['Dias_FalseNegativeNum'] + \
                             res_dict[layer]['Dias_FalsePositiveNum']
        res_dict[layer]['Dias_IOU'] = res_dict[layer]['Dias_TruePositiveNum'] / (
                res_dict[layer]['Dias_TruePositiveNum'] + res_dict[layer]['Dias_FalseNegativeNum'] + res_dict[layer][
            'Dias_FalsePositiveNum'])
        AVG_Dias_Dice_up += 2 * res_dict[layer]['Dias_TruePositiveNum']
        AVG_Dias_Dice_down += 2 * res_dict[layer]['Dias_TruePositiveNum'] + res_dict[layer]['Dias_FalseNegativeNum'] + \
                              res_dict[layer]['Dias_FalsePositiveNum']
        res_dict[layer]['Dias_IOU'] = 2 * res_dict[layer]['Dias_TruePositiveNum'] / (
                2 * res_dict[layer]['Dias_TruePositiveNum'] + res_dict[layer]['Dias_FalseNegativeNum'] +
                res_dict[layer][
                    'Dias_FalsePositiveNum'])
    ...
    res_dict['AVG_ART_Dice'] = AVG_ART_Dice_up / AVG_ART_Dice_down
    ...
    res_dict['AVG_Dias_IOU'] = AVG_Dias_IOU_up / AVG_Dias_IOU_down
    res_dict['AVG_Dias_Dice'] = AVG_Dias_Dice_up / AVG_Dias_Dice_down
